...
main() {
  ...
  // Ejemplo: 
  // Crear una función para imprimir STDOUTS en lugar de    -> Void imprimir(String texto) => stdout.writeln(texto); /  String leer() => stdin.readLineSync();
  // la siguiente línea. Luego todos los stdouts deberían ser
  // llamados usando nuestra función personalizada
  // -> funcion procesarUsuario({int salario, int id}); -> prcesarUsuario({salario: 1800, id:1});
